...
public class CalcularDocumentoIdentidadCIF {
...
//    private final String cifNumero = "ABEH";
    ...
    public CalcularDocumentoIdentidadCIF() {
    }

    /**
     * Calcula el dígito o letra de control de un documento de identificación de
     * España
     *
    ...
    /**
     * Valida un documento de identificación de España
     *
     * @param nif documento a validar
     * @return true si es válido, false si no lo es.
     */
    public boolean isvalidoDocumentoIdentificacion(String nif) {
        nif = nif.toUpperCase();
        String a = nif.substring(0, 1);
