...
INSERT INTO `articulo` (`id_articulo`,`nombre`,`precio_venta`,`precio_costo`,`stock`,`stock_minimo`,`stock_maximo`,`cod_tipo_articulo`,`cod_proveedor`,`fecha_ingreso`,`codigo_barras`) VALUES
(1, 'Bota Larga', 1000, 800, 20, 5, 30, 16, '2221', '2012-11-03',10),
(2, 'Bota corta', 700, 500, 55, 5, 30, 16, '43435', '2009-10-11',11),
(3, 'Botin ', 150, 130, 18, 5, 30, 16, '43437', '2012-09-01',14),
(4, 'Tenis ', 120, 100, 8, 5, 30, 16, '00006', '2010-10-02',12),
(5, 'Zandalias', 500, 300, 16, 5, 30, 16, '00005-8', '2012-11-01',8),
(6, 'Jeans', 900, 700, 18,  5, 30, 17, '2226', '2020-10-02',13),
(7, 'Camisas', 500, 300, 12, 5, 30, 17, '43434', '2020-10-20',7),
(8, 'Chaquetas', 700, 500, 8, 5, 30, 17, '00004-4', '2009-11-02',4),
(9, 'Chaquetas sudadera', 600, 400, 20, 5, 30, 17, '00006-7', '2011-10-23',9),
(10, 'Pantalones', 600, 400, 17, 5, 30, 17, '00001-1', '2011-10-23',1),
(11, 'Sudadera', 1000, 800, 20, 5, 30, 17, '00003-A', '2012-10-23',3),
(12, 'Camisetas', 300, 200, 30, 5, 30, 17, '2222', '2010-10-03',6); 
...
INSERT INTO `devolucion` (`id_devolucion`, `cod_detallefactura`, `cod_detallearticulo`, `Motivo`, `Fecha_devolucion`, `cantidad`,`total_devolver`, `cod_empleado`) VALUES
(1,'9910966', 3, 'pequeño', '2013-01-14', 1, 1500,1);
...
(9,'00005-8', 3, 'Marlon', 'Brandom', 'H&M','8354624','gggg@tttt.es','España','Melilla','Melilla', 'Calle 34 B 12',  8),
(10,'00006-7', 3, 'Carlos', 'sanchez diaz', 'PUL&ANDBER', '8213423','eeee@iiiii.es','España', 'Melilla','Melilla', 'calle 45 N 23-23', 9),
(11,'2221', 1, 'cccc', 'ddfff', 'DRTRE','6684756','uuuu@jjjj.es','España', 'Melilla','Melilla', 'calle dddd', 10),
(12,'43435', 1, 'fdsfdsfdsfds', 'fdsfsfds', 'MANGO','123458','rafa@nadal.ten','España','Melilla','Melilla','calle fsdfdsfds', 11),
(13,'00006', 3, 'Carlos', 'sanchez diaz', 'PPPPPP', '8213423','eeee@iiiii.es','España', 'Melilla','Melilla', 'calle 45 N 23-23', 12),
(14,'2226', 1, 'cccc', 'ddfff', 'GGGGGGG','6684756','uuuu@jjjj.es','España', 'Melilla','Melilla', 'calle dddd', 13),
(15,'43437', 1, 'fdsfdsfdsfds', 'fdsfsfds', 'BRESKA','123458','rafa@nadal.ten','España','Melilla','Melilla','calle fsdfdsfds', 14);
...
(2,'Zapatos','47922285'),
(3,'Sudadera','35987462'),
(4,'Chaquetas','35487495'),
(5,'Polos','99632582'),
(6,'Camisetas','65478947'),
(7,'Camisas','87945156'),
(8,'Zandalias','15864889'),
(9,'Chaquetas sudadera','35487400'),
(10,'Bota Larga','65478910'),
(11,'Bota Corta','87945188'),
(12,'Tenis','15864886'),
(13,'Jeans','65478933'),
(14,'Botin','87945158');
...
ALTER TABLE `articulo`
  ADD CONSTRAINT `ref_prov_art` FOREIGN KEY (`cod_proveedor`) REFERENCES `proveedor` (`No_documento`) ON UPDATE CASCADE,
