...
(1, 'Bota Larga', 1000, 800, 20, 16, '00003-A', '2012-11-03',11245788),
(2, 'Bota corta', 700, 500, 55, 16, '00003-A', '2009-10-11',3354848),
(3, 'Botin ', 150, 130, 18, 16, '00003-A', '2012-09-01',78778989),
(4, 'Tenis ', 120, 100, 8, 16, '00002-2', '2010-10-02',32322358),
(5, 'Zandalias', 500, 300, 16, 16, '00001-1', '2012-11-01',158648864),
(6, 'Jeans', 900, 700, 18, 17, '00004-4', '2020-10-02',164875913),
(7, 'Camisas', 500, 300, 12, 17, '00003-A', '2020-10-20',65478912),
(8, 'Chaquetas', 700, 500, 8, 17, '00004-4', '2009-11-02',35487495),
(9, 'Chaquetas sudadera', 600, 400, 20, 17, '00002-2', '2011-10-23',32458865),
(10, 'Pantalon sudadera', 600, 400, 17, 17, '00002-2', '2011-10-23',1325487),
(11, 'Sudadera completa', 1000, 800, 20, 17, '00002-2', '2012-10-23',35987462),
(12, 'Camisetas', 300, 200, 30, 17, '00005-F', '2010-10-03',12314487); 
...
CREATE TABLE `proveedor` (
  ...
  PRIMARY KEY (`id_proveedor`,`No_documento`),
...
(1,'00001-1', 3, 'Carlos', 'Maya', 'Estilos','11548752', 'mason@illuminati.es' , 'España', 'Melilla', 'Melilla', 'Calle 12-12', 'pantalones'),
(2,'00002-2', 3, 'Marino', 'Burbano', 'Sports','3217654300','kkkkk@lanlan.kkk','España','Melilla' , 'Melilla', 'Centro',  'zapatos'),
(3,'00003-A', 2, 'Paola', 'Sanchez', 'Fashion','7517454300','8888@hh.al','España','Melilla','Melilla', 'Veraneras',  'sudaderas'),
(4,'00004-4', 2, 'Camilo', 'Muñoz', 'Jeans&Jackets','3219843543','hh@adolf.reich','España', 'Melilla','Melilla','Centro', 'chaquetas'),
(5,'00005-F', 3, 'Marlon', 'Brandom', 'Bellas','8354624','gggg@tttt.es','España','Melilla','Melilla', 'Calle 34 B 12',  'polos'),
(6,'00006-6', 3, 'Carlos', 'sanchez diaz', 'jeans&&jeans', '8213423','eeee@iiiii.es','España', 'Melilla','Melilla', 'calle 45 N 23-23','pantalones'),
(7,'2222', 1, 'cccc', 'ddfff', 'ffff','6684756','uuuu@jjjj.es','España', 'Melilla','Melilla', 'calle dddd', 'camisetas'),
(8,'43434', 1, 'fdsfdsfdsfds', 'fdsfsfds', 'fsdfdsfds','123458','rafa@nadal.ten','España','Melilla','Melilla','calle fsdfdsfds', 'camisas');
...
ALTER TABLE `proveedor`
  ADD CONSTRAINT `ref_tipodocumento` FOREIGN KEY (`cod_tipo_documento`) REFERENCES `tipo_de_documento` (`id_tipo_documento`) ON DELETE CASCADE ON UPDATE CASCADE;
